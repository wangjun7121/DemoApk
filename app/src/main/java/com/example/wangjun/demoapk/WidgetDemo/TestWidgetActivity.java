            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.m_proDialogBtn:
                        ProgressDialog progressDialog = new ProgressDialog(TestWidgetActivity.this);
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.m_editTextBtn:
                        ...
                        Toast.makeText(TestWidgetActivity.this, inputText, Toast.LENGTH_SHORT).show();
                        break;
                    default:
                        break;
                }
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.m_alertDialogBtn:
                        AlertDialog.Builder dialog = new AlertDialog.Builder(TestWidgetActivity.this);
