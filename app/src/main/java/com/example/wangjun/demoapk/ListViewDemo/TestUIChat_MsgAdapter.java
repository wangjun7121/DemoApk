...
public class TestUIChat_MsgAdapter extends ArrayAdapter<TestUIChat_Msg> {

    // 保存了消息布局的资源 ID
    private int resourceId;

    public TestUIChat_MsgAdapter(Context context, int chatLayoutResourceId, List<TestUIChat_Msg> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TestUIChat_Msg msg = getItem(position);
        ...
        // 针对发送/接收消息，进行不同布局处理
        if (msg.getType() == TestUIChat_Msg.TYPE_RECEIVED) {
        ...
        } else if(msg.getType() == TestUIChat_Msg.TYPE_SENT) {
