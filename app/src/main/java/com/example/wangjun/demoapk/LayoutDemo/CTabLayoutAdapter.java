...
public class CTabLayoutAdapter extends FragmentPagerAdapter {
    ...
    public CTabLayoutAdapter(FragmentManager fm) {
        super(fm);
    }
    @Override
    public Fragment getItem(int position) {
        return  CTabLayoutFragment.newInstance(position,mColors[position]);
    }
    @Override
    public int getCount() {
        return mCount;
