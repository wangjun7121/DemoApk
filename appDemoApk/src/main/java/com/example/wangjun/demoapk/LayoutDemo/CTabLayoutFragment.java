...
public class CTabLayoutFragment extends Fragment {
    private int mTitle;
    private int mColor;
    private TextView mTextView;
    private LinearLayout mLinear;
    public static CTabLayoutFragment newInstance(int title, int color){
        CTabLayoutFragment fragment=new CTabLayoutFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.layoutdemo_ctablayoutfragment,container,false);
